...
/**
 * Computes the multivariate probability density in two dimensions
 * @param x value of the first random variable 
 * @param y value of the second random variable 
 * @param mu_x mean of the first random variable 
 * @param mu_y mean of the second random variable 
 * @param sigma_x std. dev. of the first random variable 
 * @param sigma_y std. dev. of the second random variable 
 */
inline double multi_gauss(double x, double y, double mu_x, double mu_y, 
...
template<typename T>
void print(std::string msg, T const& val)
{
